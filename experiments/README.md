...
| Port range | the kernel hands out 32768–60999 to any process that asks for "any port", and one host's overlay, tunnel and RPC daemons hold dozens of sockets drawn from that range | every fabric port sits below the floor, control 26300 and media 26301 upward, because losing that race is silent: JackTrip exits, the pair carries no audio, and nothing in the audio graph says why |
